...
import (
	"context"
	"fmt"
	controllerv1alpha1 "github.com/anisurrahman75/k8s-sampleController/pkg/apis/mycrd.k8s/v1alpha1"
	clientset "github.com/anisurrahman75/k8s-sampleController/pkg/client/clientset/versioned"
	informer "github.com/anisurrahman75/k8s-sampleController/pkg/client/informers/externalversions/mycrd.k8s/v1alpha1"
	lister "github.com/anisurrahman75/k8s-sampleController/pkg/client/listers/mycrd.k8s/v1alpha1"
